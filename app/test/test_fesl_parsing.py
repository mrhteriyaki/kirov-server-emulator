...
class TestAuthChainValidation:
    ...
    def test_nuloginpersona_response_format(self):
        ...
        response = NuLoginPersonaServer(
            txn='NuLoginPersona',
            userId=1000001,
            lkey='T4QdfjQBRQh0wRHDCn4qoAAAKDw.',
            profileId=2000001
        )
